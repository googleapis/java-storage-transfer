...
```Groovy
implementation 'com.google.cloud:google-cloud-storage-transfer:0.2.0'
```

If you are using SBT, add this to your dependencies

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-storage-transfer" % "0.2.0"
```
...
[javadocs]: https://googleapis.dev/java/google-cloud-storage-transfer/latest/index.html
...
[contributing]: https://github.com/googleapis/java-storage-transfer/blob/master/CONTRIBUTING.md
[code-of-conduct]: https://github.com/googleapis/java-storage-transfer/blob/master/CODE_OF_CONDUCT.md#contributor-code-of-conduct
[license]: https://github.com/googleapis/java-storage-transfer/blob/master/LICENSE
